...
public class BookServiceTest {
    ...
    void testGetById_NotFound() {
        ...
        assertThrows(BookNotExist.class, () -> bookService.getById("1"));
    }
    ...
    void testUpdateBook_NotFound() {
        ...
        assertThrows(BookNotExist.class, () -> bookService.update(bookDto, "1"));
    }
    ...
    void testDeleteBook_NotFound() {
        ...
        assertThrows(BookNotExist.class, () -> bookService.delete("1"));
